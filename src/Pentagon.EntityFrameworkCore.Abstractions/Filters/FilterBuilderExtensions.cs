namespace Pentagon.EntityFrameworkCore.Filters {
    ...
    public static class FilterBuilderExtensions
    {
        ...
        {
            return (IConnectedCompositeTextFilterBuilder<TEntity>) that.AddCompositeFilter(FilterExpressionHelper.GetObjectPropertySelector(propertySelector),FilterExpressionHelper.GetTextFilterCallback(propertySelector, filter, value));
        }
        ...
        public static IConnectedCompositeNumberFilterBuilder<TEntity> AddCompositeFilter<TEntity>(this IFilterBuilder<TEntity> that, Expression<Func<TEntity, int>> propertySelector, NumberFilter filter, int value)
                where TEntity : IEntity
        {
            return (IConnectedCompositeNumberFilterBuilder<TEntity>) that.AddCompositeFilter(FilterExpressionHelper.GetObjectPropertySelector(propertySelector), FilterExpressionHelper.GetNumberFilterCallback(propertySelector, filter, value));
        }

...
namespace Pentagon.EntityFrameworkCore
{
    ...
    public abstract class TimestampEntity<TKey> : Entity<TKey>, ICreateStampSupport, IConcurrencyStampSupport, IDeletedFlagSupport, ITimeStampSupport, IDeleteTimeStampSupport
    {
        /// <inheritdoc />

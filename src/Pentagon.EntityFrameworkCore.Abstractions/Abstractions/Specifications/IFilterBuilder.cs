namespace Pentagon.EntityFrameworkCore.Abstractions.Specifications {
            ...
            where TEntity : IEntity
    {
        ...
        ICompositeFilterBuilder<TEntity> AddCompositeFilter(Expression<Func<TEntity, object>> propertySelector, Expression<Func<TEntity, bool>> condition, object value = null);
